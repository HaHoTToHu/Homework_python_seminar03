...
# одно слово, которое содержит либо только английские, либо 
...
rus_wrd = {1: 'АВЕИНОРСТ', 2: 'ДКЛМПУ', 3: 'БГЁЬЯ', 4: 'ЙЫ', 5: 'ЖЗЧЦЧ', 8: 'ШЭЮ', 10: 'ФЩЪ'}
eng_wrd = {1: 'AEIOULNSTR', 2: 'DG', 3: 'BCMP', 4: 'FHVWY', 5: 'K', 8: 'JX', 10: 'QZ'}

word = input("Введите слово: ").upper()
count = 0
if word[0] in 'ABCDEFGHIJKLMNOPQRSTUVWXYZ':
    for letter in word:
        for key, value in eng_wrd.items():
            if letter in value:
                count += key

else:
    for letter in word:
        for key, value in rus_wrd.items():
            if letter in value:
                count += key    
